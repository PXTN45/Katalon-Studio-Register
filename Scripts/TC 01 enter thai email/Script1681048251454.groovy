...
WebUI.setText(findTestObject('Email'), 'นัทธพงศ์')

WebUI.setText(findTestObject('password'), 'Pat123456')

WebUI.setText(findTestObject('con_password'), 'Pat123456')

WebUI.click(findTestObject('checkBox'))

WebUI.verifyTextPresent('ขออภัย อนุญาตให้ใช้เฉพาะตัวอักษร (a-z), ตัวเลข (0-9), และเครื่องหมายมหัพภาค (.) เท่านั้น', false)
